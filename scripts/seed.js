  ...
  try {
    ...
    const sampleProducts = [
      ...
      // Flash Sale Items
      {
        ...
        slug: 'vitamin-c-1000mg-rose-hips-' + Date.now(),
        description: '⚡ FLASH SALE! High-potency Vitamin C with natural Rose Hips for immune support',
        detailedDescription: 'Boost your immune system with our powerful Vitamin C formula enhanced with Rose Hips for maximum absorption. Each tablet provides 1000mg of pure Vitamin C.',
        category: 'Vitamins',
        images: ['https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=800'],
        specifications: [
          { key: 'Serving Size', value: '1 Tablet' },
          { key: 'Servings Per Container', value: '90' },
          { key: 'Vitamin C', value: '1000mg' },
        ],
        productLinks: [
        ...
        sku: 'NUT-VC-001',
        tags: ['vitamin-c', 'immunity', 'antioxidant', 'flash-sale'],
        featured: true,
        status: 'inventory',
        faqs: [],
        averageRating: 4.8,
      ...
      },
      {
        ...
        slug: 'zinc-picolinate-50mg-' + Date.now(),
        description: '⚡ FLASH SALE! Highly absorbable zinc for immune function',
        detailedDescription: 'Support your immune system and overall health with our Zinc Picolinate supplement. This form of zinc is highly bioavailable for maximum effectiveness.',
        category: 'Minerals',
        images: ['https://images.unsplash.com/photo-1556909212-d5b604d0c90d?w=800'],
        specifications: [
          { key: 'Serving Size', value: '1 Capsule' },
          { key: 'Zinc (as Picolinate)', value: '50mg' },
        ],
        productLinks: [
          { platform: 'amazon', url: 'https://amazon.in', price: 599 },
        ],
        ...
        lowStockThreshold: 15,
        sku: 'NUT-ZNC-001',
        tags: ['zinc', 'immunity', 'minerals', 'flash-sale'],
        featured: false,
        status: 'inventory',
        faqs: [],
        averageRating: 4.6,
      ...
      // Trending Products
      {
        ...
        slug: 'ashwagandha-extract-600mg-' + Date.now(),
        description: 'Premium adaptogen for stress relief and energy',
        detailedDescription: 'Our high-quality Ashwagandha extract helps reduce stress, improve focus, and boost energy levels naturally. Standardized to 5% withanolides for maximum potency.',
        category: 'Herbs',
        images: ['https://images.unsplash.com/photo-1607619056574-7b8d3ee536b2?w=800'],
        specifications: [
          { key: 'Serving Size', value: '2 Capsules' },
          { key: 'Ashwagandha Extract', value: '600mg' },
          { key: 'Withanolides', value: '30mg (5%)' },
        ],
        productLinks: [
          { platform: 'amazon', url: 'https://amazon.in', price: 999 },
          { platform: 'flipkart', url: 'https://flipkart.com', price: 1049 },
        ...
        lowStockThreshold: 15,
        sku: 'NUT-ASH-001',
        tags: ['ashwagandha', 'stress-relief', 'adaptogen', 'energy'],
        featured: true,
        status: 'inventory',
        faqs: [],
        averageRating: 4.7,
      ...
      },
      {
        ...
        slug: 'turmeric-curcumin-bioperine-' + Date.now(),
        description: 'Powerful anti-inflammatory with enhanced absorption',
        detailedDescription: 'Our Turmeric Curcumin formula includes BioPerine (black pepper extract) for 2000% better absorption. Supports joint health, reduces inflammation, and provides powerful antioxidant protection.',
        category: 'Herbs',
        images: ['https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=800'],
        specifications: [
          { key: 'Serving Size', value: '2 Capsules' },
          { key: 'Turmeric Root Extract', value: '1500mg' },
          { key: 'Curcuminoids', value: '95%' },
          { key: 'BioPerine', value: '10mg' },
        ],
        productLinks: [
      ...
      },
      {
        ...
        slug: 'b-complex-b12-' + Date.now(),
        description: 'Complete B-vitamin complex for energy and metabolism',
        detailedDescription: 'Our comprehensive B-Complex provides all eight essential B vitamins in their most bioavailable forms. Supports energy production, brain function, and nervous system health.',
        category: 'Vitamins',
        images: ['https://images.unsplash.com/photo-1550572017-4245e5b4d4a1?w=800'],
        specifications: [
          { key: 'Serving Size', value: '1 Capsule' },
          { key: 'B12 (Methylcobalamin)', value: '1000mcg' },
          { key: 'All B Vitamins', value: 'Complete Complex' },
        ],
        productLinks: [
        ...
        lowStockThreshold: 15,
        sku: 'NUT-BCX-001',
        tags: ['b-complex', 'energy', 'metabolism', 'b12'],
        featured: false,
        status: 'inventory',
        faqs: [],
        averageRating: 4.5,
      ...
      },
      {
        ...
        slug: 'coq10-200mg-ubiquinol-' + Date.now(),
        description: 'Advanced heart health and cellular energy support',
        detailedDescription: 'Our CoQ10 formula uses the active Ubiquinol form for superior absorption. Supports cardiovascular health, energy production, and acts as a powerful antioxidant.',
        category: 'Supplements',
        images: ['https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=800'],
        specifications: [
          { key: 'Serving Size', value: '1 Softgel' },
          { key: 'CoQ10 (as Ubiquinol)', value: '200mg' },
        ],
        productLinks: [
          { platform: 'amazon', url: 'https://amazon.in', price: 1899 },
      ...
      },
      {
        ...
        slug: 'apple-cider-vinegar-gummies-' + Date.now(),
        description: 'Delicious gummies for weight management and digestion',
        detailedDescription: 'Enjoy all the benefits of apple cider vinegar without the harsh taste! Our gummies support weight management, healthy digestion, and detoxification.',
        category: 'Supplements',
        images: ['https://images.unsplash.com/photo-1607619056574-7b8d3ee536b2?w=800'],
        specifications: [
          { key: 'Serving Size', value: '2 Gummies' },
          { key: 'Apple Cider Vinegar', value: '500mg' },
          { key: 'Servings Per Container', value: '30' },
        ],
        productLinks: [
        ...
        lowStockThreshold: 15,
        sku: 'NUT-ACV-001',
        tags: ['apple-cider-vinegar', 'weight-management', 'digestion', 'gummies'],
        featured: false,
        status: 'inventory',
        faqs: [],
        averageRating: 4.4,
      ...
      },
      {
        ...
        slug: 'biotin-10000mcg-hair-growth-' + Date.now(),
        description: 'Maximum strength biotin for hair, skin, and nails',
        detailedDescription: 'Our high-potency Biotin supplement supports healthy hair growth, strong nails, and glowing skin. Perfect for those looking to improve their beauty from within.',
        category: 'Vitamins',
        images: ['https://images.unsplash.com/photo-1556909212-d5b604d0c90d?w=800'],
        specifications: [
          { key: 'Serving Size', value: '1 Capsule' },
          { key: 'Biotin (Vitamin B7)', value: '10,000mcg' },
          { key: 'Servings Per Container', value: '120' },
        ],
        productLinks: [
        ...
        lowStockThreshold: 20,
        sku: 'NUT-BIO-001',
        tags: ['biotin', 'hair-growth', 'beauty', 'skin-health'],
        featured: false,
        status: 'inventory',
        faqs: [],
        averageRating: 4.7,
